package com.ssll.spring6.aop.xmlaop;
...
public class LogAspect {
     ...
     * 前置通知
     */
    @Before(value = "execution(public int com.ssll.spring6.aop.xmlaop.CalculatorImpl.*(..))")
    ...
    // 后置通知
    @After(value = "execution(public int com.ssll.spring6.aop.xmlaop.CalculatorImpl.*(..))")
    ...
    // 返回通知
    @AfterReturning(value = "execution(public int com.ssll.spring6.aop.xmlaop.CalculatorImpl.*(..))", returning = "result")
    ...
    // 异常通知
    @AfterThrowing(value = "execution(public int com.ssll.spring6.aop.xmlaop.CalculatorImpl.*(..))", throwing = "e")
    ...
    // 环绕通知
    @Around(value = "execution(public int com.ssll.spring6.aop.xmlaop.CalculatorImpl.*(..))")
